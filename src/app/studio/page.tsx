...
export default function StudioPage() {
  return <main className={styles.page}>
    <header className={styles.header}>
      ...
      <nav className={styles.actions}><Link href="/">Dashboard</Link><Link href="/patterns">Grammar Patterns</Link><Link href="/word-creator">WordCreator</Link><Link href="/library">Library</Link><Link href="/quota">Codex Quota</Link><AppSwitcher /><LogoutButton /></nav>
    </header>
