...
export default function StudioPage() {
  return <main className={styles.page}>
    <header className={styles.header}>
      ...
      <nav className={styles.actions}><Link href="/">Dashboard</Link><Link href="/patterns">Grammar Patterns</Link><Link href="/library">Library</Link><AppSwitcher /><LogoutButton /></nav>
    </header>
